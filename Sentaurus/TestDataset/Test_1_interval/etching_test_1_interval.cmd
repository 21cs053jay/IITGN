...
define_species_distribution name=my_distr species=Ar+ exponent = ArExponent \
	flux="pwc(t<s>,(2,Arflux1,4,Arflux2,6,Arflux3,8,Arflux4,10,Arflux5,12,Arflux6))" sampling_time_step=0.01<s>


define_species_distribution name=my_distr species=XeF2 exponent=FrExponent \
   flux="pwc(t<s>,(2,Fflux1,4,Fflux2,6,Fflux3,8,Fflux4,10,Fflux5,12,Fflux6))" sampling_time_step=0.01<s> 
