...
#defining species distrib., yield function and machine

define_species_distribution name=my_distr species=Ar+ exponent=2.0e3 flux=2.0e-3 sampling_time_step=0.01

define_species_distribution name=my_distr species=XeF2 exponent=1.0 flux=2.0e-2 sampling_time_step=0.01

#save species_distribution=my_distr output_type=parameters file=species_distrib.tdr time=1000<s>
...
#save yield=my_yield file=yield_by_Ar.tdr
