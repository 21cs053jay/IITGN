...
define_species_distribution name=my_distr species=Ar+ exponent = 10 \
	flux="pwc(t<s>,(0,10.0e-4,2,17.0e-4,4,53.0e-4,6,100.0e-4,8,360.0e-4,10,571.0e-4,12,871.0e-4))" sampling_time_step=0.01<s> energy_min=0.0 energy_max=0.3


define_species_distribution name=my_distr species=XeF2 exponent=10 \
   flux="pwc(t<s>,(0,10.0e-3,2,17.0e-3,4,53.0e-3,6,100.0e-3,8,360.0e-3,10,571.0e-3,12, 871.0e-3))" sampling_time_step=0.01<s> energy_min=0.0 energy_max=0.3
...
save type=gc file=tdr_files/final_surface_10_.tdr
